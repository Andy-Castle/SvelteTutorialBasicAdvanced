...
<!-- Como con class, tambien puedes escribir tu en linea style
 atributos literalmente, porque svelte en realidad es
 solo html con fragmentos mas elegantes -->

<div class="container">
	Flip the card
	<!-- <button
    class="card"
		style="transform: {flipped ? 'rotateY(0)': ''}; --bg-2: black; --bg-3:goldenrod"
		onclick={() => flipped = !flipped}
	> -->
    <!-- Cunado hay muchos estilos, puede ser un poco moles, se puede
     arreglar usando el style: directiva -->
    <button
    class="card"
