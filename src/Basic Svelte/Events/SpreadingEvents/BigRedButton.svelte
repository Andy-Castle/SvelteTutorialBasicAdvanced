<!-- Tambien podemos dinfundir (spread) los controladores de
 eventos directamaente en los elementos, en este ejemplo en 
 SpreadingEvents.svelte se ha definido un onclick manejador, todo
 lo que se necesita hacer es pasar los props al button en este archivo  -->
<script>
	let props = $props();
</script>
